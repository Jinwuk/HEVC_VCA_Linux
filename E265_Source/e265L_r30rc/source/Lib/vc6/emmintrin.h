...
extern short _mm_comieq_sd(__m128d a, __m128d b);
extern short _mm_comilt_sd(__m128d a, __m128d b);
extern short _mm_comile_sd(__m128d a, __m128d b);
extern short _mm_comigt_sd(__m128d a, __m128d b);
extern short _mm_comige_sd(__m128d a, __m128d b);
extern short _mm_comineq_sd(__m128d a, __m128d b);
extern short _mm_ucomieq_sd(__m128d a, __m128d b);
extern short _mm_ucomilt_sd(__m128d a, __m128d b);
extern short _mm_ucomile_sd(__m128d a, __m128d b);
extern short _mm_ucomigt_sd(__m128d a, __m128d b);
extern short _mm_ucomige_sd(__m128d a, __m128d b);
extern short _mm_ucomineq_sd(__m128d a, __m128d b);
...
extern short _mm_cvtsd_si32(__m128d a);
extern short _mm_cvttsd_si32(__m128d a);
extern __m128d _mm_cvtsi32_sd(__m128d a, short b);
...
extern short _mm_movemask_pd(__m128d a);
extern __m128d _mm_shuffle_pd(__m128d a, __m128d b, short i);
...
extern __m128i _mm_slli_si128(__m128i a, short imm);
extern __m128i _mm_slli_epi16(__m128i a, short count);
extern __m128i _mm_sll_epi16(__m128i a, __m128i count);
extern __m128i _mm_slli_epi32(__m128i a, short count);
extern __m128i _mm_sll_epi32(__m128i a, __m128i count);
extern __m128i _mm_slli_epi64(__m128i a, short count);
extern __m128i _mm_sll_epi64(__m128i a, __m128i count);
extern __m128i _mm_srai_epi16(__m128i a, short count);
extern __m128i _mm_sra_epi16(__m128i a, __m128i count);
extern __m128i _mm_srai_epi32(__m128i a, short count);
extern __m128i _mm_sra_epi32(__m128i a, __m128i count);
extern __m128i _mm_srli_si128(__m128i a, short imm);
extern __m128i _mm_srli_epi16(__m128i a, short count);
extern __m128i _mm_srl_epi16(__m128i a, __m128i count);
extern __m128i _mm_srli_epi32(__m128i a, short count);
extern __m128i _mm_srl_epi32(__m128i a, __m128i count);
extern __m128i _mm_srli_epi64(__m128i a, short count);
...
extern __m128i _mm_cvtsi32_si128(short a);
extern short _mm_cvtsi128_si32(__m128i a);
...
extern short _mm_extract_epi16(__m128i a, short imm);
extern __m128i _mm_insert_epi16(__m128i a, short b, short imm);
extern short _mm_movemask_epi8(__m128i a);
extern __m128i _mm_shuffle_epi32(__m128i a, short imm);
extern __m128i _mm_shufflehi_epi16(__m128i a, short imm);
extern __m128i _mm_shufflelo_epi16(__m128i a, short imm);
...
extern __m128i _mm_set_epi32(short i3, short i2, short i1, short i0);
...
extern __m128i _mm_set1_epi32(short i);
...
extern __m128i _mm_setr_epi32(short i0, short i1, short i2, short i3);
...
extern void _mm_stream_si32(short *p, short i);
