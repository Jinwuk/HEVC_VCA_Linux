...
#define	E265_VERSION				"e265L_r27 (Based on HM15.0)"	
#define	E265_DEV_VERSION			"2016.11.25"
//==========================================================================
//	ETRI Debug Tools 
//==========================================================================
...
#define ETRI_SliceFrameEncoding				    1 //slice-frame encoding enable
...
#define ETRI_THREADPOOL_OPT 					0						///< Use quram threadpool
...
#define ETRI_THREAD_LOAD_BALANCING				ETRI_SliceFrameEncoding //only working with slice encoding with mutlpiple PPS option
...
// ========================================================================
#define ETRI_HDR_WCG_ENCODER		0		     // 0: Default, 1: HDR/WCG
